...
def predict(speaker_list, model_path, model_name, out_path):
    ...
    output_phone_wise(phone_wise, os.path.join(out_path, '11_phone_wise.out'), level=1)
    output_phone_sequence(phone_wise, os.path.join(out_path, '11_phone_sequence.out'), 2)
